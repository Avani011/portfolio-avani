    ...
    <div id="about" className="home">
      <div className="about-div">
            <div className="about-row1">
                ...
                <Link href="https://drive.google.com/file/d/1UWIb44R-4VFlZ4nrvGGZCZyECW0URf-1/view?usp=sharing">
            ...
            <p className="about-p">I&apos;m a passionate front-end and UI/UX 
              ...
              <p className="about-p">Im a passionate front-end and UI/UX 
              developer who crafts unique designs and 
              codes them into innovative solutions. With 
              a growth mindset and focus on clean, 
              high-quality design.
